...
function resolver() {
    ...
    for (tentativa = 1; tentativa <= 3; tentativa++) {
        let resposta = prompt(`Pensei em um número inteiro de 1 a 10, tente adivinhar qual é. Você tem ${tentativa} tentativas.`)
        divResolucao.innerHTML += `<p>Pensei em um número inteiro de 1 a 10, tente adivinhar qual é. Você tem ${tentativa} tentativas.</p>`
        if (resposta == numero) {
